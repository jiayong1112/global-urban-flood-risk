...
var floodRisk_img = ee.Image("users/Jiayong_Liang/Research_projects/FloodRiskViewGlobal_Jan26");

var imageVisParam_3view = {"opacity":1,"bands":["exDep","exDmg","exInunD"],"min":0.005,"max":0.05,"gamma":1};
Map.addLayer(floodRisk_img, imageVisParam_3view, 'flood_jan26 Flood Risk View composite', false);

var image2reduce = floodRisk_img;
...
var multiStats = image2reduce.reduceRegions({
...
.map(function(ft){
  var propertyNames = [
    ...
    'flopros_merge_count',
    'flopros_merge_mean',
    'flopros_merge_stdDev',
    'flopros_merge_sum',
    'flopros_model_count',
    'flopros_model_mean',
    'flopros_model_stdDev',
    'flopros_model_sum',
    'height_count',
    'height_mean',
    'height_stdDev',
